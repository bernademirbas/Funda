...
namespace Funda.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            #region Clients
            services.AddScoped<IFundaClient, FundaClient>();
            #endregion

            #region Options
            services.AddOptions().Configure<FundaClientOptions>(Configuration.GetSection("FundaClient"));
            #endregion
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                    name: "default",
                    pattern: "{controller=Property}/{action=Index}/{searchText?}");
            });
        }
    }
}
